...
const PhotographyGridSection = (props: Props) => {
  ...
  /*   /1* update: () => ({}), *1/ */
  /*   /1* config: { mass: 1, tension: 10000, friction: 1000 }, *1/ */
  /*   /1* trail: 0, *1/ */
  /* }) */
        ...
        {width != null &&
          gridItems.map(
            ...
            (item, key) => {
              ...
              /* console.log(item, key, props: { height, width }) */
              /* console.log({ xy, width, height, rest, key }) */
              return (
                <div
                  key={key}
                  style={{
...
/*           transitions.map( */
/*             // @ts-ignore */
/*             ({ item, key, props: { height, width, xy } }) => { */
/*               /1* console.log(item, key, props: { height, width }) *1/ */
/*               /1* console.log({ xy, width, height, rest, key }) *1/ */
/*               return ( */
/*                 <div */
/*                   key={key} */
/*                   style={{ position: 'absolute', height, width, top: xy.x }} */
/*                 > */
/*                   <ImageZoomGridElement */
/*                     image={item} */
/*                     onClick={() => openLightbox(item.index)} */
...
/*                     height, */
/*                     position: 'absolute', */
/*                     /1* transform: xy.interpolate( *1/ */
/*                     /1*   (x: number, y: number) => `translate3d(${x}px,${y}px,0)`, *1/ */
/*                     /1* ), *1/ */
/*                     width, */
/*                   }} */
/*                 > */
